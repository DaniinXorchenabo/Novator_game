...
public struct KDTreeStruct
{
    ...
    public int FindNearest2(float3 pt)
    {
    ...
    void Search2(float3 pt, ref float bestSqSoFar, ref int bestIndex, int pind)
    {
    ...
    float DistFromSplitPlane(float3 pt, float3 planePt, int axis)
    {
